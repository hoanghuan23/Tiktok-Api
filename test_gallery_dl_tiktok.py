"""Probe a TikTok photo post using gallery-dl (metadata-only, no download).

Usage:
    python test_gallery_dl_tiktok.py
    python test_gallery_dl_tiktok.py https://www.tiktok.com/@mancity/photo/7659174558100000023
    python test_gallery_dl_tiktok.py URL --cookies /path/to/cookies.txt
"""
